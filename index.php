                  ...
                  <div class="col">
                    <div class="prodimg">
                      <div class="form-group">
                        ...
                        <img src="images/choose-image-400.png" onclick="triggerClick()" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" id="prodDisplay">
                        <input type="file" style="display: none;" name="prod_img" onchange="displayImage(this)" id="prod_img">
                      </div>
                    </div>
                    <div class="form-group">
                      <button type="submit" name="add-btn" class="btn btn-primary btn-block mt-5 btn-add"> Add+ </button>
                    </div>
                  </div>
                </div>
              </div>
